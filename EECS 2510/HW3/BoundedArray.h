...
public:
    ...
    // Create bounded array with specified number of elements (all zeros) and a capacity
    // different from the default value.  Throw out of range exception for invalid size for
    // the given capacity.
